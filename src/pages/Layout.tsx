...
const Layout = () => {
  ...
  const applyDarkMode = (enabled: boolean) => {
    ...
    const preset = enabled ? DARK_COLORS : DEFAULT_COLORS;
    setCorPrimaria(preset.corPrimaria);
    setCorSecundaria(preset.corSecundaria);
    setCorFonte(preset.corFonte);
    setCorBackground(preset.corBackground);
    setCorFonteCategorias(preset.corFonteCategorias);
    setCorFonteTitulos(preset.corFonteTitulos);
    setCorFonteTituloProduto(preset.corFonteTituloProduto);
    setCorFonteSecundaria(preset.corFonteSecundaria);
    setCorBarraBotoes(preset.corBarraBotoes);
    setCorBotoes(preset.corBotoes);
    setCorFonteBotoes(preset.corFonteBotoes);
    setCorBackgroundHeader(preset.corBackgroundHeader);
    setCorDestaqueCategoriaAtiva(preset.corDestaqueCategoriaAtiva);
    setCorFonteCategoriaAtiva(preset.corFonteCategoriaAtiva);
  };
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Aplica automaticamente uma paleta escura em toda a loja. Você ainda pode ajustar cores individualmente abaixo.
                </p>
              </div>
